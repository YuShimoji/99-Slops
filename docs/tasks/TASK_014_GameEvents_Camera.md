...
## Dependency
- `TASK_013_CameraSettings_SO` の Settings 参照化が完了していること
...
## Deliverables
- `Assets/_Project/Scripts/Systems/GameEventBus.cs` にカメライベント追加
- `Assets/_Project/Scripts/Camera/CameraManager.cs` に発火処理追加
- `Assets/_Project/Scripts/Systems/GameEventDebugLogger.cs` にログ処理追加
...
- 回帰: 既存 `GameEventBus` イベント（Prop/Beam）に影響がないことを確認
